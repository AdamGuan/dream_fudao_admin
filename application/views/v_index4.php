		...
		<div class="am-panel am-panel-default">
			...
			<div id="collapse-panel-2" class="am-in">
				<table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
					...
					<tr>
						<td class="am-text-center"><img src="<?php echo get_assets_image_url('examples/admin-chrome.png');?>" alt=""></td>
						<td>Google Chrome</td>
						<td>3,005</td>
					</tr>
					<tr>
						<td class="am-text-center"><img src="<?php echo get_assets_image_url('examples/admin-firefox.png');?>" alt=""></td>
						<td>Mozilla Firefox</td>
						<td>2,505</td>
					</tr>
					<tr>
						<td class="am-text-center"><img src="<?php echo get_assets_image_url('examples/admin-ie.png');?>" alt=""></td>
						<td>Internet Explorer</td>
						<td>1,405</td>
					</tr>
					<tr>
						<td class="am-text-center"><img src="<?php echo get_assets_image_url('examples/admin-opera.png');?>" alt=""></td>
						<td>Opera</td>
						<td>4,005</td>
					</tr>
					<tr>
						<td class="am-text-center"><img src="<?php echo get_assets_image_url('examples/admin-safari.png');?>" alt=""></td>
						<td>Safari</td>
						<td>505</td>
					</tr>
					</tbody>
