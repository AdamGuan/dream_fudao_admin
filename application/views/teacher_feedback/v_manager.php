	...
	<div class="am-u-md-3 am-cf">
		<div class="am-fr">
			<div class="am-input-group am-input-group-sm">
				<input type="text" class="am-form-field" placeholder="输入老师姓名或学生搜索" id="search_text" value="<?php echo $search_text;?>">
...
<thead>
<tr>
	<th>序号</th><th>教师姓名</th><th>学生姓名</th><th>订单ID号</th><th>开始时间</th><th>结束时间</th><th>反馈信息</th>
</tr>
</thead>
<tbody>
<?php foreach($playback_list as $k=>$playback){
	...
	$str .= '<td>'.$playback['F_end_time'].'</td>';
	$str .= '<td>'.$playback['F_teacher_feedback'].'</td></tr>';
	echo $str;
}?>
</tbody>
</table>
